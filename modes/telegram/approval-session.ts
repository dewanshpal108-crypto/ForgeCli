...
import type { ActionTracker } from '../cli/agent/action-tracker.ts';
import type { ToolExecutor } from '../cli/agent/tool-executor.ts';
import type { ActionLog } from '../cli/agent/types.ts';
import { composeBeforeAfter, formatPatch } from '../cli/agent/diff-view.ts';
